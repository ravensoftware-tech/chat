...
public class ApiDialogHelper {
    ...
    public static Dialog createError(final Context context, final int code) {
        ...
        switch (code) {
            case QuickChatService.API_ERROR_AIRPLANE_MODE:
                res = R.string.no_network_connection;
                break;
            case QuickChatService.API_ERROR_OTHER:
                res = R.string.unknown_api_error_network;
                break;
            case QuickChatService.API_ERROR_CONNECT:
                res = R.string.unable_to_connect_to_server;
                break;
            case QuickChatService.API_ERROR_SSL_HANDSHAKE:
                res = R.string.unable_to_establish_secure_connection;
                break;
            case QuickChatService.API_ERROR_UNKNOWN_HOST:
                res = R.string.unable_to_find_server;
                break;
            case QuickChatService.API_ERROR_SSL_CERTIFICATE:
                res = R.string.unable_to_verify_server_identity;
                break;
            case QuickChatService.API_ERROR_SSL_GENERAL:
                res = R.string.unknown_security_error;
                break;
            case QuickChatService.API_ERROR_TIMEOUT:
