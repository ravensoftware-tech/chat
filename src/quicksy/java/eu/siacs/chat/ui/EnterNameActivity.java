...
import tech.ravensoftware.chat.databinding.ActivityEnterNameBinding;
...
public class EnterNameActivity extends XmppActivity
    ...
    private void next(final View view) {
        ...
        final Intent intent;
        if (AbstractQuickChatService.isQuicksyPlayStore()) {
            intent = StartConversationActivity.startOrChatActivity(this, account);
        } else {
