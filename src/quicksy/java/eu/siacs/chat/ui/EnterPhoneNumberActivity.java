...
import tech.ravensoftware.chat.databinding.ActivityEnterNumberBinding;
import tech.ravensoftware.chat.entities.Account;
import tech.ravensoftware.chat.services.QuickChatService;
import tech.ravensoftware.chat.ui.drawable.TextDrawable;
...
public class EnterPhoneNumberActivity extends XmppActivity
        implements QuickChatService.OnVerificationRequested {
    ...
    private void onPhoneNumberEntered(Phonenumber.PhoneNumber phoneNumber) {
        ...
        xmppConnectionService.getQuickChatService().requestVerification(phoneNumber);
    }
