...
import tech.ravensoftware.chat.databinding.ActivityVerifyBinding;
import tech.ravensoftware.chat.entities.Account;
import tech.ravensoftware.chat.services.QuickChatService;
import tech.ravensoftware.chat.ui.util.ApiDialogHelper;
import tech.ravensoftware.chat.ui.util.PinEntryWrapper;
...
public class VerifyActivity extends XmppActivity
        implements ClipboardManager.OnPrimaryClipChangedListener,
                QuickChatService.OnVerification,
                QuickChatService.OnVerificationRequested {
    ...
    private void onNextButton(View view) {
        ...
        if (PinEntryWrapper.isValidPin(pin)) {
            if (account != null && xmppConnectionService != null) {
                ...
                xmppConnectionService.getQuickChatService().verify(account, pin);
            }
        } else {
    ...
    public void onBackendConnected() {
        xmppConnectionService.getQuickChatService().addOnVerificationListener(this);
        xmppConnectionService
                .getQuickChatService()
        ...
        setVerifyingState(xmppConnectionService.getQuickChatService().isVerifying());
        setRequestingVerificationState(
                xmppConnectionService.getQuickChatService().isRequestingVerification());
    }
    ...
    public void onStop() {
        ...
        if (xmppConnectionService != null) {
            xmppConnectionService.getQuickChatService().removeOnVerificationListener(this);
            xmppConnectionService
                    .getQuickChatService()
