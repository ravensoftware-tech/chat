package tech.ravensoftware.chat.ui.service;
...
import tech.ravensoftware.chat.services.MediaPlayer;
...
import tech.ravensoftware.chat.utils.WeakReferenceSet;
    ...
    private void startStop(final MaterialButton playPause) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU
            ...
            ActivityCompat.requestPermissions(
                    ...
                    ChatActivity.REQUEST_PLAY_PAUSE);
            return;
        }
