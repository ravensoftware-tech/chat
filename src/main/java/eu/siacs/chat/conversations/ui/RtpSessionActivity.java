...
import tech.ravensoftware.chat.databinding.ActivityRtpSessionBinding;
...
import tech.ravensoftware.chat.ui.util.MainThreadExecutor;
import tech.ravensoftware.chat.ui.util.Rationals;
...
import tech.ravensoftware.chat.xmpp.jingle.ContentAddition;
...
public class RtpSessionActivity extends XmppActivity
        implements XmppConnectionService.OnJingleRtpConnectionUpdate,
                tech.ravensoftware.chat.ui.widget.SurfaceViewRenderer.OnAspectRatioChanged {
    ...
    private static final List<RtpEndUserState> STATES_SHOWING_SPEAKER_CONFIGURATION =
            new ImmutableList.Builder<RtpEndUserState>()
                    ...
                    .build();
    private static final String PROXIMITY_WAKE_LOCK_TAG = "chat:in-rtp-session";
    ...
    private void recordVoiceMail(final View view) {
        ...
        final Intent launchIntent = new Intent(this, ChatActivity.class);
        launchIntent.setAction(ChatActivity.ACTION_VIEW_CONVERSATION);
        launchIntent.putExtra(ChatActivity.EXTRA_CONVERSATION, conversation.getUuid());
        launchIntent.setFlags(intent.getFlags() | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        launchIntent.putExtra(
                ChatActivity.EXTRA_POST_INIT_ACTION,
                ChatActivity.POST_ACTION_RECORD_VOICE);
