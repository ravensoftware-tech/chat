...
import tech.ravensoftware.chat.databinding.ActivityUriHandlerBinding;
...
import tech.ravensoftware.chat.utils.ProvisioningUtils;
...
public class UriHandlerActivity extends BaseActivity {
    ...
    private static Class<?> findShareViaAccountClass() {
        try {
            return Class.forName("tech.ravensoftware.chat.ui.ShareViaAccountActivity");
    ...
    public void onActivityResult(final int requestCode, final int resultCode, final Intent intent) {
        ...
        if (requestCode == REQUEST_SCAN_QR_CODE && resultCode == RESULT_OK) {
            ...
            if (result.startsWith("BEGIN:VCARD\n")) {
                ...
                return;
            } else if (QuickChatService.isChat()
