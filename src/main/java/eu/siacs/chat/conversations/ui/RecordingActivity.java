...
import tech.ravensoftware.chat.databinding.ActivityRecordingBinding;
...
public class RecordingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private File generateOutputFilename(final int outputFormat) {
        ...
        final File chatDirectory = new File(parentDirectory, getString(R.string.app_name));
        return new File(chatDirectory, filename);
    }
