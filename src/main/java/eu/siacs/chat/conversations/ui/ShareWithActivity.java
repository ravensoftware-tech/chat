...
import tech.ravensoftware.chat.databinding.ActivityShareWithBinding;
...
public class ShareWithActivity extends XmppActivity
    ...
    private final List<Conversation> mChat = new ArrayList<>();
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mAdapter = new ConversationAdapter(this, this.mChat);
    ...
    private String shortcutIdToConversation(final String shortcutId) {
        ...
        if (shortcut.isPresent()) {
            ...
            if (extras == null) {
                ...
                final var conversation = extras.getString(ChatActivity.EXTRA_CONVERSATION);
    ...
    public void onStart() {
        ...
        populateShare(intent);
        if (xmppConnectionServiceBound) {
            xmppConnectionService.populateWithOrderedChat(
                    mChat, this.share.uris.isEmpty(), false);
        }
    }
    ...
    private void populateShare(final Intent intent) {
        ...
        if (Intent.ACTION_SEND.equals(action)) {
            ...
            final boolean asQuote =
                    intent.getBooleanExtra(ChatActivity.EXTRA_AS_QUOTE, false);
    ...
    private void share(final String conversation) {
        ...
        intent.putExtra(ChatActivity.EXTRA_CONVERSATION, conversation);
        if (!share.uris.isEmpty()) {
            intent.setAction(Intent.ACTION_SEND_MULTIPLE);
            intent.putParcelableArrayListExtra(Intent.EXTRA_STREAM, share.uris);
            intent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
            if (share.type != null) {
                intent.putExtra(ChatActivity.EXTRA_TYPE, share.type);
            }
            ...
            intent.putExtra(ChatActivity.EXTRA_AS_QUOTE, share.asQuote);
        }
        try {
    ...
    public void refreshUiReal() {
        ...
        xmppConnectionService.populateWithOrderedChat(
                mChat, this.share != null && this.share.uris.isEmpty(), false);
