...
import tech.ravensoftware.chat.databinding.ActivityShowLocationBinding;
import tech.ravensoftware.chat.ui.util.LocationHelper;
import tech.ravensoftware.chat.ui.util.UriHelper;
import tech.ravensoftware.chat.ui.widget.Marker;
import tech.ravensoftware.chat.ui.widget.MyLocation;
import tech.ravensoftware.chat.utils.GeoHelper;
import tech.ravensoftware.chat.utils.LocationProvider;
...
public class ShowLocationActivity extends LocationActivity implements LocationListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        switch (Strings.nullToEmpty(action)) {
            case "tech.ravensoftware.chat.location.show":
