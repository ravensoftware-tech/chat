...
import tech.ravensoftware.chat.databinding.ItemConversationBinding;
...
public class ConversationAdapter
    ...
    private final List<Conversation> chat;
    private OnConversationClickListener listener;

    public ConversationAdapter(XmppActivity activity, List<Conversation> chat) {
    ...
    public void onBindViewHolder(@NonNull ConversationViewHolder viewHolder, int position) {
        Conversation conversation = chat.get(position);
