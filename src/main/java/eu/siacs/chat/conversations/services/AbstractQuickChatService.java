...
public abstract class AbstractQuickChatService {
    ...
    public AbstractQuickChatService(XmppConnectionService service) {
    ...
    public static boolean isChat() {
        return "chat".equals(BuildConfig.FLAVOR_mode);
    }
    ...
    public static boolean isContactListIntegration(final Context context) {
        ...
        final var readContacts = AbstractQuickChatService.declaredReadContacts;
        if (readContacts != null) {
            return Boolean.TRUE.equals(readContacts);
        }
        AbstractQuickChatService.declaredReadContacts = hasDeclaredReadContacts(context);
        return AbstractQuickChatService.declaredReadContacts;
    }
