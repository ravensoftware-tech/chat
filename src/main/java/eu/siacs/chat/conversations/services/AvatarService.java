...
import tech.ravensoftware.chat.entities.RawBlockable;
...
public class AvatarService {
    ...
    private AvatarWithSurface get(
        ...
        if (contact.getAvatar() != null && QuickChatService.isQuicksy()) {
            final var byHash =
    ...
    private static Character getFirstLetter(final Avatar avatar) {
        if (avatar instanceof Account a) {
            ...
            if (QuickChatService.isChat() || Strings.isNullOrEmpty(displayName)) {
